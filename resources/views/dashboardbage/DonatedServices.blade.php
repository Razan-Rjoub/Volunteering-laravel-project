      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
           ...
           <td>
               <a href="{{ url('/donatedservives/' . $item->id  . '/edit' ) }}" > <button class="btn btn-warning btn-sm">Edit</button></a>


           <!-- Delete Admin form (you can use a modal for confirmation) -->

           <form method="POST" action="{{ url('/donatedservives' . '/' . $item->id  ) }}" style="display: inline;">
                    @csrf
                    @method('DELETE')
