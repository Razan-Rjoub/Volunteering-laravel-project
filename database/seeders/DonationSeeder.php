...
class DonationSeeder extends Seeder
{
    ...
    public function run()
    {
        Donation::create([
            ...
            'image' => 'http://127.0.0.1:8000/assets/img/img_v_2-min.jpg',
            'amount_needed' => 2000,
        ]);
        Donation::create([
            ...
            'image' => 'http://127.0.0.1:8000/assets/img/img_v_3-min.jpg',
            'amount_needed' => 4000,
        ]);
        Donation::create([
            ...
            'image' => 'http://127.0.0.1:8000/assets/img/img_v_4-min.jpg',
            'amount_needed' => 1000,
        ]);
    }
}